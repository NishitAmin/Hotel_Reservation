...
import ca.sheridancollege.aminnis.repositories.HotelRepository;
import ca.sheridancollege.aminnis.repositories.PaymentRepository;
import ca.sheridancollege.aminnis.repositories.ReceiptRepository;
import ca.sheridancollege.aminnis.repositories.ReservationRepository;
import ca.sheridancollege.aminnis.repositories.RoleRepository;
import ca.sheridancollege.aminnis.repositories.RoomRepository;
import ca.sheridancollege.aminnis.repositories.UserRepository;
...
public class HomeController {
	...
	public String insertHotel(Model model, @RequestParam String search, Authentication authentication, @PathVariable String username) {
		...
		String name = authentication.getName();
		GooglePlaces client = new GooglePlaces(""/*Google Places API*/);
